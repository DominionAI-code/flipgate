...
const getArticleData = (slug) => {
  const repository = {
    ...
    "empowering-next-generation-skills": {
      ...
      category: "Education",
      content:
        "Education is more than theory; it requires strategic optimization pipelines that give individuals immediate global leverage. This publication covers the foundational frameworks FLIPE is establishing behind the scenes to support automated verified learning tracks, interactive workshops, and developer resource pipelines across the continent.",
    },
  };
...
export async function generateMetadata({ params }) {
  ...
  return {
    title: `${article.title} | FLIPE Insights`,
